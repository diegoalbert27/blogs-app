...
describe('handler of blogs likes', () => {
  const listWithBlogs = [
    {
  ...
  test('find the most voted blog from the list', () => {
    const expectBlog = {
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      likes: 12
  ...
  test('Return the author wiht most blogs', () => {
    const expectBlog = {
      author: 'Robert C. Martin',
      blogs: 3
    }
  ...
  test('Return the author wiht most likes', () => {
    const expectBlog = {
      author: 'Edsger W. Dijkstra',
      likes: 17
    }
